/* ═══════════════════════════════════════════════════════════════════════
   ...
   les marques dont il a besoin : les calques de lumière, le découpage
   des paragraphes et la vitesse de défilement.
   ═══════════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ── 2. Le texte s'allume mot par mot ──────────────────────────────── */
  (function reader() {
  ...
  /* ── 3. La vitesse du défilement fait pencher la page ──────────────── */
  (function skew() {
    if (reduce.matches) return;
  ...
  /* ── 4. Le rang de chaque carte d'une pile, et l'ordre des puces ───── */
  (function rangs() {
  ...
  /* ── 7. L'inclinaison 3D qui suit le curseur ───────────────────────
